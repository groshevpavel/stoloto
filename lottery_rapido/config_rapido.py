from stoloto.parsers.sl_rapido import FIRST_DRAW_DAYS_AGO
...
class LotteryConfig:
    ...
    PARSE_MAX_CONCURRENCY = 100
    SLGD_MAX_CONCURRENCY = 2

    GET_ARCHIVE_DAYS_AGO = 1 if sl_files.check_exist(CSV_FILENAME_LOTTERY_DATA) else FIRST_DRAW_DAYS_AGO
